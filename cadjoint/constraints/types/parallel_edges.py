...
from cadjoint.constraints.types._sketch import coerce_parameter_fields, cross_2d, require_values
...
class ParallelEdgesConstraint(Constraint):
    ...
    :class:`~cadjoint.constraints.types.parallel.ParallelConstraint`, which
