...
from cadjoint.meshing._lattice import _flatten, _strides, _unflatten
from cadjoint.meshing.edge_detection import CrossingEdges, GridSpec
from cadjoint.meshing.features import _CELL_EDGE_OFFSETS
...
def sparse_crossing_edges(
    ...
    *,
    ...
    :func:`cadjoint.meshing.edge_detection.find_crossing_edges` over a dense
    ...
    Args:
        ...
        return_inside: Also return a boolean inside lattice shaped like
            ...
            :func:`cadjoint.meshing.features.manifold_cell_incidence` carry
