...
samples produced by :mod:`cadjoint.meshing.edge_detection`, decide which grid
...
from cadjoint.meshing.edge_detection import CrossingEdges, GridSpec, HermiteData
...
def manifold_cell_incidence(
    ...
    Args:
        edges: Crossing edges from
            :func:`cadjoint.meshing.edge_detection.find_crossing_edges`.
