...
- **Feature preservation.**  Mesh edges whose dihedral angle exceeds
  ...
  :func:`~jaxcad.meshing.features.classify_feature_cells` or the seam rows
  of :func:`~jaxcad.meshing.features.detect_branch_changes`, both of which
...
from jaxcad.meshing.dual_contouring import Mesh
    ...
    *,
    ...
    Args:
        ...
        feature_mask: Optional boolean mask over the mesh's vertex rows
            ...
            :func:`~jaxcad.meshing.features.classify_feature_cells` or seam
            rows from
            :func:`~jaxcad.meshing.features.detect_branch_changes`, both
    ...
    Returns:
        A new :class:`~jaxcad.meshing.dual_contouring.Mesh` whose vertices
