...
def save_stl(mesh: Mesh, path: str | Path, *, binary: bool = True) -> None:
    ...
    if binary:
        ...
        header = b"jaxcad binary STL export".ljust(80, b"\0")
...
FILE_NAME('mesh','',('jaxcad'),(''),'jaxcad','jaxcad','');
...
_STEP_BOILERPLATE = (
    ...
    "PRODUCT('jaxcad_mesh','jaxcad_mesh','',(#3))",
...
def save_step(mesh: Mesh, path: str | Path) -> None:
    ...
    brep_id = add(f"MANIFOLD_SOLID_BREP('jaxcad_mesh',#{shell_id})")
