...
Proves the jaxcad FEM interop ABI: mesh + boundary conditions cross the
...
solver plugs into jaxcad by shipping exactly this file shape and pointing
``jaxcad.fem.backends.TesseractBackend(api_path=...)`` at it.
...
def _solve(points, cells, dirichlet_nodes, dirichlet_values, conductivity, source, base_points):
    ...
    from jaxcad.fem.backends import JaxFemBackend, ThermalBCs
