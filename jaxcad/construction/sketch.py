...
Generators (:func:`jaxcad.construction.extrude`,
:func:`jaxcad.construction.revolve`) turn profiles into SDF nodes that share
...
a wireframe overlay on top of rendered images (see ``jaxcad.render.overlay``).
"""
...
from jaxcad.geometry.parameters import Vector, Vector2, as_parameter
