...
[![The playground in Model mode: the scene program on the left, the parametric heat sink rendered live on the right, and the declared cool-sink optimization in the side dock](../examples/assets/playground-model.png)](../examples/assets/playground-model.png)
...
![The declared SimMesh discretized into tet10 elements, shaded by element quality with a quality histogram](../examples/assets/playground-mesh.png)
...
![The solved temperature field, clipped by the slice plane so the flux entering at the die interface is visible](../examples/assets/playground-field.png)
...
![The finished cool-sink optimization: convergence sparkline, trajectory scrubber, and each parameter's before and after value](../examples/assets/playground-optimize.png)
...
<div class="cadjoint-webgpu-demo" data-cadjoint-webgpu-viewer>
  ...
  <img data-viewer-fallback src="../examples/assets/playground-model.png" alt="The cadjoint playground with the scene program on the left and the heat sink rendered on the right">
