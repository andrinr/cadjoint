...
[![The playground in Model mode: the scene program on the left, the parametric heat sink rendered live on the right, and the declared cool-sink optimization in the side dock](../docs/assets/screens/model-desk.png)](../docs/assets/screens/model-desk.png)
...
![The declared SimMesh discretized into tet10 elements, shaded by element quality with a quality histogram](../docs/assets/screens/simulate-meshes.png)
...
![The solved temperature field, clipped by the slice plane so the flux entering at the die interface is visible](../docs/assets/screens/simulate-results.png)
...
![The finished cool-sink optimization: convergence sparkline, trajectory scrubber, and each parameter's before and after value](../docs/assets/screens/optimize-replay.png)
...
<div class="cadjoint-webgpu-demo" data-cadjoint-webgpu-viewer>
  ...
  <img data-viewer-fallback src="../docs/assets/screens/model-desk.png" alt="The cadjoint playground with the scene program on the left and the heat sink rendered on the right">
